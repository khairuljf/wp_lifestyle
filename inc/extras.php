 ...
 */
function lifestyle_header_menu() {
          ...
          echo '<li><a href="'. get_permalink() .'">';
            if ( (function_exists( 'has_post_thumbnail' )) && ( has_post_thumbnail() ) ) :
              ...
              echo '<div class="flex-caption">';
                if ( get_the_category() != '' ) echo '<h2 class="slider_category">'. the_category().'</h2>';
                  if ( get_the_title() != '' ) echo '<h2 class="entry-title">'. wp_trim_words( get_the_title(), 5 ).'</h2><br>'; ?>

                
<div class="author"><span><?php sparkling_posted_on(); ?></span><span>&nbsp;&nbsp;&nbsp;<i class="fa fa-user" aria-hidden="true"></i> <?php the_author(); ?></span></div>
